        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <p className="max-w-[500px] mb-9 text-white/80">
              ...
              dynamic and responsive web applications. My passion for coding
              drives me to explore the foundations of backend development to
              enhance my own projects and continuously expand my skill set.
            </p>
            {/* socias */}
